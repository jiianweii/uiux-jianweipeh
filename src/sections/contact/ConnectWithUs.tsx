...
export default function ConnectWithUs() {
  return (
    <Section className="h-[80svh] items-center">
          ...
          <div className="grid grid-cols-3 gap-4">
            <Section layout="col" className="gap-6">
              ...
              >
                ...
                <div>
                  <Text size="xxs">152 Bishan Street #01-215 (2nd Floor)</Text>
                </div>
              </Section>
            ...
            <Section layout="col" className="gap-6">
              ...
              >
                ...
                <div>
                  <Text size="xxs">+65 8849 8106</Text>
                  <Text size="xxs">tuition@ancourage.net</Text>
                </div>
              </Section>
            ...
            <Section layout="col" className="gap-6">
              ...
              >
                ...
                <div>
                  ...
                  <Text size="xxs">@artbyancourage</Text>
                </div>
              </Section>
